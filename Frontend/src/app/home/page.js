  ...
  const tweets = [
    {
      ...
      user: {
        name: "Sarah Chen",
        handle: "sarahdesigns",
        avatar: "https://images.unsplash.com/photo-1494790108755-2616b812b833?w=40&h=40&fit=crop&crop=face"
      },
      content: "Just shipped a new design system component library! 🎉 The amount of developer happiness this is going to create makes all the late nights worth it.",
      timestamp: "2h",
      replies: 12,
      retweets: 89,
      likes: 234,
    ...
    },
    {
      ...
      content: "Breaking: Major breakthrough in quantum computing achieved by researchers at MIT. This could revolutionize encryption and cybersecurity as we know it.",
      timestamp: "4h",
      replies: 156,
      retweets: 1200,
      likes: 3400
    },
    {
      ...
      content: "Hot take: Writing good documentation is harder than writing the actual code. Change my mind. 🧵",
      timestamp: "6h",
      replies: 89,
      retweets: 45,
      likes: 312
    },
    {
      ...
      content: "Beautiful minimal website designs that prove less is more ✨ Thread below with 10 examples that will inspire your next project 👇",
      timestamp: "8h",
      replies: 23,
      retweets: 167,
      likes: 892,
    ...
    },
    {
      ...
      content: "Year 1 of my startup: Failed 47 times, succeeded 3 times. Those 3 times changed everything. Persistence isn't just motivational poster material—it's the actual game.",
      timestamp: "12h",
      replies: 78,
      retweets: 234,
      likes: 1567
                ...
                <div className="flex items-center justify-between max-w-md mt-3">
                  ...
                  >
                    ...
                    <span className="text-sm">
                      {retweetedTweets.has(tweet.id) ? tweet.retweets + 1 : tweet.retweets}
                    </span>
                  </button>
                  ...
                  >
                    <div className="p-2 rounded-full group-hover:bg-red-50 transition-colors">
                      <Heart 
                        className={`w-4 h-4 ${likedTweets.has(tweet.id) ? 'fill-current' : ''}`} 
                      />
                    </div>
                    <span className="text-sm">
                      {likedTweets.has(tweet.id) ? tweet.likes + 1 : tweet.likes}
                    </span>
                  </button>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <Bookmark 
                        className={`w-4 h-4 ${bookmarkedTweets.has(tweet.id) ? 'fill-current' : ''}`} 
                      />
                    </button>
                  </div>
                </div>
